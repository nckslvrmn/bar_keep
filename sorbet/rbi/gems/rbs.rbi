...
class RBS::AST::Ruby::Members::MethodTypeAnnotation
  ...
  def map_type_name(&block); end
  def overloads; end
  def self.build(leading_block, trailing_block, variables); end
...
class RBS::EnvironmentLoader::Library < Anonymous_Struct_44
end
...
class RBS::DefinitionBuilder::MethodBuilder::Methods::Definition < Anonymous_Struct_45
  def accessibility; end
  def original; end
...
class RBS::Prototype::RB::Context < Anonymous_Struct_46
