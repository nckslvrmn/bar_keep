...
ActiveRecord::Schema[8.1].define(version: 2026_04_15_000001) do
  ...
  create_table "categories_items", id: false, force: :cascade do |t|
    ...
    t.index ["item_id", "category_id"], name: "index_categories_items_on_item_id_and_category_id", unique: true
  end
  ...
  create_table "item_metadata", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "value"
    t.index ["item_id", "key"], name: "index_item_metadata_on_item_id_and_key", unique: true
